...
-- ── Hoy 12-Mar — En Ruta ─────────────────────────────────────
(44, '2026-03-12 07:00:00', '2026-03-12 09:50:00',  7, 2,  4,  5),
(45, '2026-03-12 08:30:00', '2026-03-12 09:15:00',  2, 2,  5,  6),
(46, '2026-03-12 10:00:00', '2026-03-12 12:00:00',  3, 2,  6,  7),
-- ── Marzo 2026 — Disponibles (13-30 mar) ─────────────────────
(47, '2026-03-13 07:00:00', '2026-03-13 09:50:00',  7, 1,  7,  8),
(48, '2026-03-13 09:00:00', '2026-03-13 09:45:00',  2, 1,  8,  9),
(49, '2026-03-14 08:00:00', '2026-03-14 10:00:00',  3, 1,  9, 10),
(50, '2026-03-14 10:00:00', '2026-03-14 12:50:00',  7, 1, 10,  1),
(51, '2026-03-15 07:30:00', '2026-03-15 09:30:00',  4, 1,  1,  2),
(52, '2026-03-15 14:00:00', '2026-03-15 16:50:00',  8, 1,  2,  3),
(53, '2026-03-16 08:00:00', '2026-03-16 08:45:00',  1, 1,  3,  4),
(54, '2026-03-17 09:00:00', '2026-03-17 11:50:00',  7, 1,  4,  5),
(55, '2026-03-18 07:00:00', '2026-03-18 09:00:00',  3, 1,  5,  6),
(56, '2026-03-19 10:00:00', '2026-03-19 12:15:00',  5, 1,  6,  7),
(57, '2026-03-20 08:00:00', '2026-03-20 08:45:00',  2, 1,  7,  8),
(58, '2026-03-21 07:00:00', '2026-03-21 09:50:00',  7, 1,  8,  9),
(59, '2026-03-22 09:00:00', '2026-03-22 11:00:00',  4, 1,  9, 10),
(60, '2026-03-23 08:00:00', '2026-03-23 10:50:00',  8, 1, 10,  1),
(61, '2026-03-24 07:30:00', '2026-03-24 09:30:00',  3, 1,  1,  2),
(62, '2026-03-25 10:00:00', '2026-03-25 12:50:00',  7, 1,  2,  3),
(63, '2026-03-26 08:00:00', '2026-03-26 08:45:00',  1, 1,  3,  4),
(64, '2026-03-27 09:00:00', '2026-03-27 11:15:00',  5, 1,  4,  5),
(65, '2026-03-28 07:00:00', '2026-03-28 09:50:00',  7, 1,  5,  6),
(66, '2026-03-29 08:00:00', '2026-03-29 10:00:00',  3, 1,  6,  7),
(67, '2026-03-30 10:00:00', '2026-03-30 12:50:00',  7, 1,  7,  8);
...
-- Marzo
(17, '2026-03-01 07:30:00', 1035.00, 1,  1),  -- viaje 29  (12x90 - desc niño/adultoM)
(18, '2026-03-01 09:30:00', 3395.00, 2,  4),  -- viaje 30  (10x350 - desc)
(19, '2026-03-02 07:00:00', 2136.00, 1,  7),  -- viaje 31  (9x240 - desc)
(20, '2026-03-03 08:30:00', 2800.00, 2,  4),  -- viaje 32  (8x350)
(21, '2026-03-04 07:45:00',  621.00, 1,  1),  -- viaje 33  (7x90 - desc)
(22, '2026-03-05 06:15:00', 1926.00, 1, 10),  -- viaje 36  (11x180 - desc)
(23, '2026-03-06 06:00:00', 4462.50, 2,  4),  -- viaje 37  (13x350 - desc)
(24, '2026-03-07 07:30:00', 2388.00, 1,  7),  -- viaje 38  (10x240 - desc)
(25, '2026-03-08 08:30:00',  696.00, 1,  1),  -- viaje 39  (8x90 - desc)
(26, '2026-03-09 09:30:00', 5162.50, 2,  4),  -- viaje 40  (15x350 - desc)
(27, '2026-03-10 07:00:00', 2148.00, 1,  7),  -- viaje 41  (9x240 - desc)
(28, '2026-03-11 07:30:00', 1668.00, 1,  1),  -- viaje 42  (7x240 - desc)
(29, '2026-03-12 05:30:00',  861.00, 1,  1),  -- viaje 43  (10x90 - desc)
(30, '2026-03-12 06:30:00', 6212.50, 2,  4),  -- viaje 44  (18x350 - desc)
(31, '2026-03-12 08:00:00',  531.00, 1,  1),  -- viaje 45  (6x90 - desc)
(32, '2026-03-12 09:30:00', 4728.00, 2,  7);  -- viaje 46  (20x240 - desc)
...
-- ── Viaje 2 (TJ-MXL $350, bus 2) ─────────────────────────────
(9,  350.00, '2026-01-10 07:05:00', 53, 2,  9, 1,  2),
-- ── Viaje 3 (TJ-ENS $240, bus 3) ─────────────────────────────
...
-- ── Viaje 29 (TJ-RSO $90, bus 1) — 1-Mar ─────────────────────
...
-- ── Viaje 30 (TJ-MXL $350, bus 2) — 1-Mar ───────────────────
...
-- ── Viaje 31 (TJ-ENS $240, bus 3) — 2-Mar ───────────────────
...
-- ── Viaje 32 (TJ-MXL $350, bus 4) — 3-Mar ───────────────────
...
-- ── Viaje 33 (RSO-TJ $90, bus 5) — 4-Mar ────────────────────
...
-- ── Viaje 36 (ENS-TJ $180 ruta 4, bus 6) — 5-Mar ─────────────
...
-- ── Viaje 37 (MXL-TJ $350, bus 7) — 6-Mar ───────────────────
...
-- ── Viaje 38 (TJ-ENS $240, bus 8) — 7-Mar ───────────────────
...
-- ── Viaje 39 (TJ-RSO $90, bus 9) — 8-Mar ────────────────────
...
-- ── Viaje 40 (TJ-MXL $350, bus 10) — 9-Mar ──────────────────
...
-- ── Viaje 41 (TJ-ENS $240, bus 1) — 10-Mar ──────────────────
...
-- ── Viaje 42 (ENS-TJ $240, bus 2) — 11-Mar ──────────────────
...
-- ── Viaje 43 (TJ-RSO $90, bus 3) — 12-Mar finalizado ─────────
...
-- ── Viaje 44 (TJ-MXL $350, bus 4) — 12-Mar en ruta ───────────
(171, 350.00, '2026-03-12 06:30:00', 151, 44,  9, 1, 30),
(172, 350.00, '2026-03-12 06:30:00', 152, 44, 10, 1, 30),
(173, 262.50, '2026-03-12 06:30:00', 153, 44,104, 4, 30),
(174, 350.00, '2026-03-12 06:30:00', 154, 44, 11, 1, 30),
(175, 350.00, '2026-03-12 06:30:00', 155, 44, 12, 1, 30),
(176, 350.00, '2026-03-12 06:30:00', 156, 44, 13, 1, 30),
(177, 245.00, '2026-03-12 06:30:00', 157, 44, 74, 3, 30),
(178, 350.00, '2026-03-12 06:30:00', 158, 44, 14, 1, 30),
(179, 350.00, '2026-03-12 06:30:00', 159, 44, 15, 1, 30),
(180, 350.00, '2026-03-12 06:30:00', 160, 44, 16, 1, 30),
(181, 262.50, '2026-03-12 06:30:00', 161, 44,105, 4, 30),
(182, 350.00, '2026-03-12 06:30:00', 162, 44, 17, 1, 30),
(183, 350.00, '2026-03-12 06:30:00', 163, 44, 18, 1, 30),
(184, 350.00, '2026-03-12 06:30:00', 164, 44, 19, 1, 30),
(185, 350.00, '2026-03-12 06:30:00', 165, 44, 20, 1, 30),
(186, 350.00, '2026-03-12 06:30:00', 166, 44, 21, 1, 30),
(187, 350.00, '2026-03-12 06:30:00', 167, 44, 22, 1, 30),
(188, 350.00, '2026-03-12 06:30:00', 168, 44, 23, 1, 30),
-- ── Viaje 45 (RSO-TJ $90, bus 5) — 12-Mar en ruta ────────────
(189,  90.00, '2026-03-12 08:00:00', 197, 45, 24, 1, 31),
(190,  90.00, '2026-03-12 08:00:00', 198, 45, 25, 1, 31),
(191,  45.00, '2026-03-12 08:00:00', 199, 45, 43, 2, 31),
(192,  90.00, '2026-03-12 08:00:00', 200, 45, 26, 1, 31),
(193,  63.00, '2026-03-12 08:00:00', 201, 45, 71, 3, 31),
(194,  90.00, '2026-03-12 08:00:00', 202, 45, 27, 1, 31),
-- ── Viaje 46 (TJ-ENS $240, bus 6) — 12-Mar en ruta ───────────
(195, 240.00, '2026-03-12 09:30:00', 246, 46, 28, 1, 32),
(196, 240.00, '2026-03-12 09:30:00', 247, 46, 29, 1, 32),
(197, 180.00, '2026-03-12 09:30:00', 248, 46,106, 4, 32),
(198, 240.00, '2026-03-12 09:30:00', 249, 46, 30, 1, 32),
(199, 240.00, '2026-03-12 09:30:00', 250, 46,  1, 1, 32),
(200, 168.00, '2026-03-12 09:30:00', 251, 46, 72, 3, 32),
(201, 240.00, '2026-03-12 09:30:00', 252, 46,  2, 1, 32),
(202, 240.00, '2026-03-12 09:30:00', 253, 46,  3, 1, 32),
(203, 180.00, '2026-03-12 09:30:00', 254, 46,107, 4, 32),
(204, 240.00, '2026-03-12 09:30:00', 255, 46,  4, 1, 32),
(205, 240.00, '2026-03-12 09:30:00', 256, 46,  5, 1, 32),
(206, 240.00, '2026-03-12 09:30:00', 257, 46,  6, 1, 32),
(207, 240.00, '2026-03-12 09:30:00', 258, 46,  7, 1, 32),
(208, 168.00, '2026-03-12 09:30:00', 259, 46, 73, 3, 32),
(209, 240.00, '2026-03-12 09:30:00', 260, 46,  8, 1, 32),
(210, 240.00, '2026-03-12 09:30:00', 261, 46,  9, 1, 32),
(211, 240.00, '2026-03-12 09:30:00', 262, 46, 10, 1, 32),
(212, 240.00, '2026-03-12 09:30:00', 263, 46, 11, 1, 32),
(213, 240.00, '2026-03-12 09:30:00', 264, 46, 12, 1, 32),
(214, 240.00, '2026-03-12 09:30:00', 265, 46, 13, 1, 32);
...
SELECT 'viajes marzo' AS tabla, COUNT(*) AS total
  FROM viaje WHERE fecHoraSalida >= '2026-03-01';